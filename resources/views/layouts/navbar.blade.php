            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        ...
                        <ul class="pro-body">
                            <li><a href="{{ route('appointments.index') }}" class="dropdown-item"><i
                                        class="feather icon-calendar"></i> Agendamentos</a></li>
                            <li><a href="{{ route('users.edit', $user->id) }}" class="dropdown-item"><i
                                        class="feather icon-settings"></i> Configuração</a></li>
