...
<head>
    ...
    <title>NC | Agendamento de Consultas Online</title>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('index') }}"> <img
                                src="{{ asset('img/landing/logo.png') }}" alt="logo" width="60" height="60"> Novo
                            Consultório
                        </a>
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Independente da sua segmentação médica. Novo Consultório foi feito e
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
                        <a href="https://www.facebook.com/profile.php?id=61556169657327"><i class="ti-facebook"></i></a>

                        <a href="https://www.instagram.com/doze.strategy/"><i class="ti-instagram"></i></a>
